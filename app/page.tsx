    ...
    <div id="top" className="editorial-home">
      ...
      <section className="editorial-campaign">
        <div className="container campaign-grid">
          <article className="campaign-card image-safe"><img src="/models/model-pink.webp" alt="AI-generated female fashion model in a soft pink LOLA ENGLAND look" width="1000" height="1300" loading="lazy" /><div className="campaign-copy"><span>01 · SOFT PINK</span><h3>Pretty, but never predictable.</h3><p>Soft colour, relaxed energy and a tee you will actually want to wear again tomorrow.</p></div></article>
      ...
      <section className="editorial-section" aria-labelledby="style-rail-title">
        <div className="container">
          ...
          <div className="model-rail">
            {railLooks.map((look) => <article className="model-rail-card image-safe" key={look.title}><img src={look.image} alt={`AI-generated LOLA ENGLAND female model, ${look.title}`} width="1000" height="1300" loading="lazy" /><div className="rail-copy"><span>{look.label}</span><strong>{look.title}</strong></div></article>)}
          </div>
        </div>
      </section>
      ...
      <section className="container editorial-join" id="contact">
        ...
        <div className="editorial-join-copy"><p className="editorial-eyebrow">JOIN THE LOLA LIST</p><h2>First look.<br /><em>First picks.</em></h2><p>New drops, limited edits and easy everyday style — straight to your inbox.</p><form><input type="email" placeholder="Your email address" aria-label="Your email address" required /><button type="submit">JOIN</button></form></div>
      </section>
