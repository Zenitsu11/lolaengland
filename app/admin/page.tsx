...
export default function AdminPage(){
  ...
  return <div className="admin-shell">
    ...
    <section className="admin-main">
      ...
      {tab==='overview'&&<><div className="admin-card"><div className="admin-row"><div><h2>Data exports</h2><p>Download owner data for printing, accounting or offline records.</p></div><div className="admin-actions"><button className="admin-btn" disabled={exporting} onClick={()=>exportData('xlsx','all')}>Download Excel</button><button className="admin-btn" disabled={exporting} onClick={()=>exportData('pdf','all')}>Download PDF</button><button className="admin-btn ghost" disabled={exporting} onClick={()=>exportData('xlsx','newsletter')}>Newsletter Excel</button></div></div></div><div className="stats">
