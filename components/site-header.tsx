...
export function SiteHeader() {
  ...
  return <>
    ...
    <header className="header"><div className="nav container">
      <a className="brand" href="#top"><img className="brand-mark" src="/logo.svg" alt="LOLA ENGLAND" style={{objectFit:'cover',objectPosition:'center',padding:0}}/><span>LOLA</span></a>
