    ...
    <>
      ...
      <header className="header">
        <div className="nav container">
          <a className="brand" href="#top"><span className="brand-mark">LOLA</span><span>LOLA</span></a>
          <nav className="desktop-nav"><a href="#shop">Shop</a><a href="#about">Our story</a><a href="#faq">FAQ</a><a href="#contact">Contact</a></nav>
          <div className="actions">
            <button aria-label="Search"><Search /></button><button aria-label="Wishlist"><Heart /></button><button aria-label="Shopping bag"><ShoppingBag /></button>
            <button className="menu" onClick={() => setOpen(true)} aria-label="Open menu"><span/><span/></button>
          </div>
        </div>
      </header>
