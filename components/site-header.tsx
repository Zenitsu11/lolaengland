...
<a className="brand" href="#top" aria-label="LOLA ENGLAND home"><span className="brand-frame"><img className="brand-logo" src="/Lola england.jpg" alt="LOLA ENGLAND"/></span></a>
