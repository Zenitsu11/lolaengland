...
<div className="actions"><a href="/search" aria-label="Search"><Search/></a><a href="/wishlist" aria-label="Wishlist"><Heart/></a><a href="/cart" aria-label="Shopping bag"><ShoppingBag/></a><button className="menu" onClick={()=>setOpen(true)} aria-label="Open menu"><Menu/></button></div>
</div></header>
